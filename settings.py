...
DATABASE_NAME = '/home/reportingsite/reporting.sql'             # Or path to database file if using sqlite3.
...
MEDIA_ROOT = '/home/reportingsite/media/'
