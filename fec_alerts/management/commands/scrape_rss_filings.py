...
#from outside_spending_2014.models import CommitteeOverlay
from fec_alerts.models import new_filing, processing_memo, Filing_Scrape_Time
from outside_spending_2014.models import Committee_Overlay, Committee


from outside_spending_2014.read_FEC_settings import FILECACHE_DIRECTORY, USER_AGENT, FEC_DOWNLOAD, DELAY_TIME, CYCLE
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # old url #2. Migration out scheduled for end of 2013
        # rss_url = "http://fecapps.nictusa.com/rss/generate?preDefinedFilingType=ALL"
        
        # Is this caching every 30 minutes or so? Should we break with querystring somehow? 
