...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('outside_spending_newcommittee', (
        ...
        db.send_create_signal('outside_spending', ['newCommittee'])


    def backwards(self, orm):
        
        # Deleting model 'newCommittee'
        db.delete_table('outside_spending_newcommittee')
