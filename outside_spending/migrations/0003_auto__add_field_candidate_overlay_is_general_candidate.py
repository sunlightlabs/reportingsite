...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Candidate_Overlay.is_general_candidate'
        db.add_column('outside_spending_candidate_overlay', 'is_general_candidate', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Candidate_Overlay.is_general_candidate'
        db.delete_column('outside_spending_candidate_overlay', 'is_general_candidate')
