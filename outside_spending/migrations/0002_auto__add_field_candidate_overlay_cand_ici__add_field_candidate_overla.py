...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Candidate_Overlay.cand_ici'
        db.add_column('outside_spending_candidate_overlay', 'cand_ici', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True), keep_default=False)

        # Adding field 'Candidate_Overlay.cand_ttl_receipts'
        db.add_column('outside_spending_candidate_overlay', 'cand_ttl_receipts', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=2), keep_default=False)

        # Adding field 'Candidate_Overlay.cand_total_disbursements'
        db.add_column('outside_spending_candidate_overlay', 'cand_total_disbursements', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=2), keep_default=False)

        # Adding field 'Candidate_Overlay.cand_ending_cash'
        db.add_column('outside_spending_candidate_overlay', 'cand_ending_cash', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=2), keep_default=False)

        # Adding field 'Candidate_Overlay.cand_ttl_ind_contribs'
        db.add_column('outside_spending_candidate_overlay', 'cand_ttl_ind_contribs', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=2), keep_default=False)

        # Adding field 'Candidate_Overlay.cand_cand_contrib'
        db.add_column('outside_spending_candidate_overlay', 'cand_cand_contrib', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=2), keep_default=False)

        # Adding field 'Candidate_Overlay.cand_cand_loans'
        db.add_column('outside_spending_candidate_overlay', 'cand_cand_loans', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=2), keep_default=False)

        # Adding field 'Candidate_Overlay.cand_debts_owed_by'
        db.add_column('outside_spending_candidate_overlay', 'cand_debts_owed_by', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=2), keep_default=False)

        # Adding field 'Candidate_Overlay.cand_report_date'
        db.add_column('outside_spending_candidate_overlay', 'cand_report_date', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Candidate_Overlay.cand_ici'
        db.delete_column('outside_spending_candidate_overlay', 'cand_ici')

        # Deleting field 'Candidate_Overlay.cand_ttl_receipts'
        db.delete_column('outside_spending_candidate_overlay', 'cand_ttl_receipts')

        # Deleting field 'Candidate_Overlay.cand_total_disbursements'
        db.delete_column('outside_spending_candidate_overlay', 'cand_total_disbursements')

        # Deleting field 'Candidate_Overlay.cand_ending_cash'
        db.delete_column('outside_spending_candidate_overlay', 'cand_ending_cash')

        # Deleting field 'Candidate_Overlay.cand_ttl_ind_contribs'
        db.delete_column('outside_spending_candidate_overlay', 'cand_ttl_ind_contribs')

        # Deleting field 'Candidate_Overlay.cand_cand_contrib'
        db.delete_column('outside_spending_candidate_overlay', 'cand_cand_contrib')

        # Deleting field 'Candidate_Overlay.cand_cand_loans'
        db.delete_column('outside_spending_candidate_overlay', 'cand_cand_loans')

        # Deleting field 'Candidate_Overlay.cand_debts_owed_by'
        db.delete_column('outside_spending_candidate_overlay', 'cand_debts_owed_by')

        # Deleting field 'Candidate_Overlay.cand_report_date'
        db.delete_column('outside_spending_candidate_overlay', 'cand_report_date')
