...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Candidate_Overlay.cand_is_gen_winner'
        db.add_column('outside_spending_candidate_overlay', 'cand_is_gen_winner', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Candidate_Overlay.cand_is_gen_winner'
        db.delete_column('outside_spending_candidate_overlay', 'cand_is_gen_winner')
