"""Load up line parsers for the forms that we care about. By keeping 'em in one central wrapper class we don't have to keep initializing 'em"""
...
class form_parser():
    ...
    def is_allowed_form(self, form_name):
        try:
            ...
            print "Not a parseable form: %s - %s" % (form_name, form_name)
            return False
